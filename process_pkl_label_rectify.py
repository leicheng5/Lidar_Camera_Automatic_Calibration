...
import sys
# # Alias the new core package under the old name
...
def save_pkl_data(labeled_data, camera_data, lidar_data, label, cam_key, 
    ...
    image = camera_data[cam_key]['pixels']
    if SHOW:
        # Display the image
        plt.imshow(image)
...
if __name__ == '__main__':    
    ...
    base_dir = r'/xdisk/caos/leicheng/FHWA/dataset4_rectify' #r'/xdisk/caos/leicheng/FHWA/dataset3_rectify'
    save_dir = r'/xdisk/caos/leicheng/FHWA/Lei_dataset4_rectify' #r'/xdisk/caos/leicheng/FHWA/Lei_dataset3_rectify' 
    ...
    for folder_name in sorted(os.listdir(base_dir)):
        ...
        if os.path.isdir(folder_path):
            ...
            # camera              
            gen_frame_data(camera_data, os.path.join(root,'lei_camera_dataset4_rectify'))
            # lidar              
            gen_frame_data(lidar_data,  os.path.join(root,'lei_lidar_dataset4_rectify'))
