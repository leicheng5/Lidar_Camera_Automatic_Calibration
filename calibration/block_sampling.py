...
image_width = 1280
image_height = 720
num_cols = 256 #128#80#64#32#16   #1280 #
num_rows = 144 #72 #60#48#24#12   #720 #
...
output_file_path = './calib_results/filtered_paired_ctds_2d.pkl'
...
assigned_regions = {}
for pixel_coord, img_lid_coord in zip(pixel_coords, data):
...
# Save  as an .npy file
np.save(os.path.join(save_path,'selected_pairs_array.npy'), selected_pixels_array) 
