...
if __name__ == "__main__":
    ...
    cam_frame_dir   = r'/xdisk/caos/leicheng/FHWA/lei_camera_dataset3_rectify'
    lid_frame_dir   = r'/xdisk/caos/leicheng/FHWA/lei_lidar_dataset3_rectify'
    ...
    max_dis_cost    =  150
    #------------------------------------------------------#
    output_path = './calib_results_rectify_dataset3'
    if not os.path.exists(output_path):
        os.makedirs(output_path)   
    save_path = './video_results_rectify_dataset3'
    ...
    ####    Create video   #############################################################            
    output_filename = 'LC_paired_points_dataset3.avi'
