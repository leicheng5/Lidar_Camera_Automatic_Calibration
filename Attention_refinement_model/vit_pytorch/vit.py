...
#############################  Lei   ###########################################
class ViT(nn.Module):
    ''' Modified by Lei. The pretrained weights loading refers to https://github.com/liyiersan/MSA
    Args:
    ...
    conv_patch: use conv for patch embedding.
    '''
    def __init__(self, *, image_size, patch_size, num_classes, dim, depth, heads, mlp_dim, pool = 'cls', channels = 3, dim_head = 64, dropout = 0., emb_dropout = 0., qkv_bias=False, conv_patch=True):
        super().__init__()
    ...
    def forward(self, img):
        ...
        # cls_tokens used in Fine_Tune_Model is not for the classification instead 
        #   for the global feat of the whole img
        # num_class now is for the feat_dim
