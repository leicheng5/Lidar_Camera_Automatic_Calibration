...
if __name__ == '__main__':    
    ...
    base_dir = r'/xdisk/caos/leicheng/FHWA/dataset3'
    save_dir = r'/xdisk/caos/leicheng/FHWA/Lei_dataset3' 
    ...
    for folder_name in sorted(os.listdir(base_dir)):
        ...
        if os.path.isdir(folder_path):
            ...
            # camera              
            gen_frame_data(camera_data, os.path.join(root,'lei_camera_dataset3'))
            # lidar              
            gen_frame_data(lidar_data,  os.path.join(root,'lei_lidar_dataset3'))
